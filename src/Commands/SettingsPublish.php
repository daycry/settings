...
class SettingsPublish extends BaseCommand
{
    ...
    protected function publishConfig()
    {
        ...
        $content = str_replace('namespace Daycry\Settings\Config', "namespace Config", $content);
        $content = str_replace('extends BaseConfig', "extends \Daycry\Settings\Config\Settings", $content);
